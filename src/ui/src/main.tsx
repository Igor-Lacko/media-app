			...
			<Routes>
				<Route path="/" element={<MainPage />}>
					...
					<Route path="tv-shows/*">
						...
						/>
						<Route
							path=":id/:seasonId/edit"
							element={<AddSeasonPage />}
						/>
						<Route
							path=":id/:seasonId/add"
							element={<AddEpisodePage />}
						/>
						<Route
							path=":id/:seasonId/:episodeId"
							element={<EpisodeDetail />}
						/>
						<Route
							path=":id/:seasonId/:episodeId/edit"
							element={<AddEpisodePage />}
						/>
						<Route
							path=":id/:seasonId/:episodeId/play"
					...
					<Route path="courses/*">
						...
						/>
						<Route
							path=":id/:lectureId/edit"
							element={<AddLecturePage />}
						/>
						<Route
							path=":id/:lectureId/play"
