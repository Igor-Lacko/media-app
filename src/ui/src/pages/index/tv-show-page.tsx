...
export default function TvShowPage() {
	...
	const tvShowListProps: ListProps = {
		...
		items:
			SortMedia<TvShow>(data || [], sort, ascending).filter(
				(tvShow: TvShow) =>
		...
		notFoundMessage:
			"There are no TV shows that match your search criteria.",
	};
	...
	return (
		<div
			className={
				"flex w-full h-full flex-col items-center justify-center p-0 m-0"
			}
		>
