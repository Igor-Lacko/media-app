	...
	return (
		<div
			className={classNames(
                ...
                transition-all bg-black z-30 overflow-visible duration-500 ease-in-out backdrop-blur-md "
		...
		>
			...
			<div
				className={
					"flex w-full items-center justify-start px-5 py-5 h-15"
				}
			>
				{/** Play, Pause */}
				<div
					className={
						"flex items-center justify-start text-gray-500 w-1/10 h-full"
					}
				>
					{playing ?
						<FaPause
							className={
								"text-gray-500 ml-5 text-2xl cursor-pointer hover:text-gray-600"
							}
				...
				<div
					className={
						"flex items-center justify-start w-2/10 h-full space-x-5 text-gray-500 text-lg"
					}
				>
					Forward/Backward
					<FaBackward
						className={
							"text-gray-500 text-2xl cursor-pointer hover:text-gray-600 ml-5"
						}
						onClick={onGoBack}
					/>
					<FaForward
				...
				<div
					className={
						"flex items-center justify-center w-2/10 h-full text-gray-500 text-lg"
					}
				>
