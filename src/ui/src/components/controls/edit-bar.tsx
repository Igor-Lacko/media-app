...
export default function EditBar(props: EditBarProps) {
	return (
		<div
			className={
				"flex items-center w-full h- border-b-2 border-gray-400 dark:border-gray-600\
                    px-5 justify-between pt-5 pb-10"
			}
		>
			<div className={"flex items-center justify-start space-x-5"}>
				{props.addTitle && props.onAdd && (
					<RoundedButton
						text={props.addTitle}
						onClick={props.onAdd}
						extraClassNames={
							"bg-green-500 dark:bg-green-700 hover:bg-green-600"
						}
						icon={<FaPlus />}
					/>
				)}
				{props.editTitle && props.onEdit && (
					<RoundedButton
				...
				{props.deleteTitle && props.onDelete && (
					<RoundedButton
						text={props.deleteTitle}
						onClick={props.onDelete}
						extraClassNames={
							"bg-red-500 dark:bg-red-700 hover:bg-red-600"
						}
						icon={<FaTrash />}
					/>
				)}
				{props.playTitle && props.onPlay && (
					<RoundedButton
						text={props.playTitle}
						onClick={props.onPlay}
						extraClassNames={
							"bg-purple-500 dark:bg-purple-700 hover:bg-purple-600"
						}
						icon={<FaPlay />}
					/>
				)}
				{props.onAddNote && (
					<RoundedButton
						...
						extraClassNames={
							"bg-yellow-500 dark:bg-yellow-600 hover:bg-yellow-700"
						}
						icon={<FaPlus />}
					/>
				)}
			...
			<div className={"flex items-center justify-start space-x-5"}>
				...
				{props.onSetDescription && (
					<RoundedButton
						...
						extraClassNames={
							"bg-purple-500 dark:bg-purple-600 hover:bg-purple-700"
						}
						icon={<FaPencilAlt />}
					/>
				)}
				{props.onSetWatchStatus && (
					<RoundedButton
