...
export default function HeaderRating({
	...
	return (
		...
		>
			<span
				className={
					"text-gray-500 dark:text-gray-400 text-xl font-medium italic flex justify-center"
				}
			>
			...
			<div
				className={
					"flex items-center w-full justify-center space-x-1 text-yellow-500"
				}
			>
				{stars}
			</div>
