...
import SidebarButtonProps from "utils/interface/props/sidebar-button-props";
        ...
        <NavLink
            ...
            className={( { isActive }  : {isActive : boolean}) => 
                classNames (
                    ...
                    dark:text-gray-300 text-lg md:text-base sm:text-sm font-semibold transition-all duration-300 ease-in-out",
                    {
                        // Active
