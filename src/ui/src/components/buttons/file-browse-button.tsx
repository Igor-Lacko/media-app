...
export default function FileBrowseButton({
	...
	return (
		<div
			className={
				"flex items-center justify-start w-full h-10 rounded-lg\
		...
		>
			<button
				className={
					"cursor-pointer rounded-lg h-full p-2 text-sm items-center justify-center bg-purple-800 dark:bg-purple-600\
			...
			<span
				className={
					"ml-2 text-gray-500 dark:text-gray-300 flex justify-start items-center h-full\
