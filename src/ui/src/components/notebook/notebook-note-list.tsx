 ...
 */
export default function NotebookNoteList({
	notes,
	updateNotes,
	onNoteClick,
	extraClassNames,
	...
	return (
		<div
			className={
				"flex flex-col w-full h-full overflow-y-auto overlfow-x-hidden space-y-3 p-5 "
				+ (extraClassNames || "")
			}
		>
					...
					>
						{note.timestamp !== undefined
							&& note.timestamp !== null && (
								<div
									className={
										"flex items-center justify-start w-full p-3 h-auto text-black dark:text-gray-400"
									}
								>
									<FaCircle
										className={
											"text-purple-500 mr-2 text-sm"
										}
									/>
									<span
										className={
											"text-sm md:text-base lg:text-lg mr-2 hover:underline cursor-pointer"
										}
										onClick={() =>
						...
						<div
							className={classNames(
								...
								{
									"border-t-1 border-gray-200 dark:border-gray-700":
										note.timestamp,
								},
							)}
						>
						...
						<div
							className={
								"flex items-center justify-end w-full p-3 mb-2"
							}
						>
							<FaTrash
								className={
									"cursor-pointer mr-3 text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-600"
								}
								onClick={async () => {
