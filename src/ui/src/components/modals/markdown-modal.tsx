    ...
    return (
        <div className={"fixed inset-0 flex items-center justify-center backdrop-blur-sm bg-opacity-50 z-50"}>
            ...
            >
                ...
                <MDEditor
                    className={"w-full min-h-3/4 mt-3 border rounded-lg dark:bg-gray-700 dark:text-gray-200 text-black overflow-y-auto"}
                    value={text}
                    onChange={(value) => {
                        if (value) {
                            setText(value);
                ...
                >
                    ...
                    <RoundedButton
                        text={"Save"}
                        extraClassNames={"bg-blue-500 text-white hover:bg-blue-600 dark:hover:bg-blue-700 dark:bg-blue-600"}
                        onClick={async () => {
                            if (props.onSetText) {
