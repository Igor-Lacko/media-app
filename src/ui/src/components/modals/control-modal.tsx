...
/**
 * Returns a modal component with a control component for editing.
 * @param props Title, message, onClose, domponent, classNames
 * @returns A modal component.
 */
export default function ControlModal(props : ModalProps) {
    return (
