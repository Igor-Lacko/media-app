...
export default function FormSection({ children, title, classNames } : { children : React.ReactNode, title : string, classNames? : string }) {
    return (
        <div className={"flex w-full flex-col items-start justify-start p-5 border-t\
                border-gray-300 dark:border-gray-600 " + (classNames || "")}>
            <h2 className={"text-3xl font-semibold text-gray-700 dark:text-gray-400 mt-10 mb-5"}>
                {title}
            </h2>
