...
export default function TextAreaOption({
	...
	return (
		<div
			className={
				"flex flex-col w-full ml-8 space-y-3 items-start justify-center p-4 "
				+ (extraClassnames || "")
			}
		>
			<span
				className={
					"text-lg mb-5 flex font-semibold items-center h-1/5 text-gray-700 dark:text-gray-400"
				}
			>
				{title}
			</span>
			<textarea
				className={
					"w-full h-4/5 p-2 border border-gray-300 dark:border-gray-600 rounded-lg text-black dark:text-gray-400 \
