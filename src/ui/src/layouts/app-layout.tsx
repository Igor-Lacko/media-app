		...
		<SettingsContext value={{ settings, setSettings }}>
			<div
				className={classNames(
					...
					{ dark: settings.darkMode, light: !settings.darkMode },
				)}
			>
				{isIndexPage && (
					<Sidebar
				...
				<div
					className={
						"flex flex-col flex-grow h-full m-0 items-start justify-start space-y-2 w-full"
					}
				>
					{isIndexPage && (
						<div className="flex w-full h-1/25 sm:h-1/20 items-center justify-end pt-4 pr-4">
							<FaBars
								className={classNames(
