...
export default function FormLayout<T>(props: FormProps<T>) {
	...
	return (
		<div
			className={
				"flex flex-col w-full h-full items-center justify-start\
                    overflow-x-hidden overflow-y-auto bg-white dark:bg-gray-800"
			}
		>
			<div
				className={
					"flex items-center justify-start ml-10 mt-5 w-full h-auto sm:h-1/20"
				}
			>
				<FaArrowLeft
			...
			<div
				className={
					"flex items-center justify-center w-full h-auto mt-10 mb-5 p-2"
				}
			>
				<h1
					className={
						"text-4xl font-bold text-gray-800 dark:text-gray-400"
					}
				>
					{props.title}
				</h1>
			...
			<div
				className={
					"flex flex-col w-full h-auto items-center justify-start space-y-10"
				}
			>
				<div className={"flex-grow w-full"}>{props.children}</div>
				<div
					className={
						"flex w-full items-end justify-between p-4 border-t\
